...
// This is a fallback component that doesn't rely on the OpenAI API
// It can be used if the API is not working or if you want to test the UI without making API calls
export function TitleStepFallback({ data, updateData, onNext, onBack }: TitleStepProps) {
  ...
  // Simple client-side refinement without API call
  ...
  // Simple client-side title generation without API call
